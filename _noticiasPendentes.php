...
$objFL->checaLogin('administrar-noticia');
...
<html lang="pt-br">
    <head>
        ...
        <script src="/js/scripts/_noticiasPendentes.js"></script>
    </head>
    <body>
        <div id="all">
            <header>
            ...
            <article id="article">
                <div class="enquadramento1000px">
                    ...
                    <article class="boxList">
                        ...
                        if ($objNoticias->qtdPendenteRegistros() <= 0) {
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $count = 1;
                                if ($objNoticias->qtdPendenteRegistros() > 0)
                                foreach ($objNoticias->listarPendenteTudo() as $obj) {
                                    $count++;
                                    ...
                                    <tr$classPar>
                                        ...
                                        <td class=\"alLeft\" href=\"/$tipoUrl/noticias/$obj->codigo/visualizar.html\">$obj->titulo</td>
                                        <td class=\"alCenter\">
                                            <a title=\"Excluir\" data-codigo=\"$obj->codigo\">Excluir</a>
                                            <a title=\"Liberar\" data-codigo=\"$obj->codigo\">Liberar</a>
                                        </td>
                                    </tr>
                                ";
                                }
                    ...
                    <a class="btnVoltar" href="/<?php print $tipoUrl; ?>/noticias/">Voltar</a>
                </div>
            </article>
            <div class="clear"></div>
        </div>
