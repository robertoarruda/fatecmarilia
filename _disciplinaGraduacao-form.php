...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $objDisciplina->cursos_codigo->codigo = returnPost('cursos_codigo');
    
    $dir = "/$tipoUrl/disciplinas/graduacao/";
    $erro = "
        <script>
        $.showMsg({
...
foreach ($objCursos->listarTudo() as $obj) {
    $selected = ($objDisciplina->cursos_codigo->codigo == $obj->codigo) ? ' selected=\"selected\"' : '';
...
$str = <<<STR
        ...
        >
        <label for="cursos_codigo">Curso</label>
        <select
            id="cursos_codigo"
            name="cursos_codigo"
        >$curso</select>
...
<html lang="pt-br">
    <head>
        ...
        <script src="/js/scripts/_disciplinaGraduacao-form.js"></script>
    </head>
            ...
            <article id="article">
                <div class="enquadramento1000px">
                    ...
                    <article class="boxForm">
                        <h1>Cadastro de Disciplina de Cursos de Graduação</h1>
                        <form method="post">
                            <?php print $str; ?>
                        </form>
                    </article>
