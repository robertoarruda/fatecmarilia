...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['LoginAluno'])) {
        ...
        if ($objALogin = $objALogin->logar(returnPost('LoginAluno'), returnPost('SenhaAluno'))) {
            $objAluno = new Aluno();
            if (!$objAluno->consultar($objALogin->cpf)) {
                ...
                switch ($objALogin->situacao) {
                    case 'A':
                        $objALogin->gerarSessao($objALogin->cpf);
                    ...
                    <ul id="boxLogin">
                        <li>
                            <article class="boxLogin">
                                ...
                                <form id="frmAlunos" action="/login/" method="post">
                                    <label for="LoginAluno">Email</label>
                                    <input id="LoginAluno" name="LoginAluno" type="email">
                                    <label for="SenhaAluno">Senha</label>
                                    <input id="SenhaAluno" name="SenhaAluno" type="password">
                                    <div class="login">
                                        <input type="submit" class="btnLogin" title="Entrar" value="Entrar">
                                        <p>
                                            <a href="/login/aluno/recuperar-senha.html">Não consegue acessar a sua conta?</a>
                                            <a href="/login/aluno/solicitacao.html">Não possui uma conta? Cadastre já!</a>
                                        </p>
                                    </div>
                                </form>
                            </article>
