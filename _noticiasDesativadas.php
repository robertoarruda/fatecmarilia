...
<html lang="pt-br">
    <head>
        ...
        <script src="/js/scripts/_noticiasDesativadas.js"></script>
    </head>
    <body>
        <div id="all">
            <header>
            ...
            <article id="article">
                <div class="enquadramento1000px">
                    ...
                    <article class="boxList">
                        <h1>Notícias Desativadas</h1>
                        <?php
                        $objNoticias = new Noticia();
                        if ($objNoticias->qtdDesativoRegistros() <= 0) {
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $count = 1;
                                if ($objNoticias->qtdDesativoRegistros() > 0)
                                foreach ($objNoticias->listarDesativoTudo() as $obj) {
                                    $count++;
