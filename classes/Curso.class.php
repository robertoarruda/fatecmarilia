...
class Curso {
    ...
    private $imagem;
    private $perfilProfissiografico;
    private $estruturaCurricular;
    private $duracao;
    ...
    public function consultar($p) {
        ...
        if ($res) {
            ...
            $obj->perfilProfissiografico = stripslashes($reg['perfilProfissiografico']);
            $obj->estruturaCurricular = stripslashes($reg['estruturaCurricular']);
