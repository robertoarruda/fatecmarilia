...
class DisciplinaPos {
    ...
    public function __construct() {
        $this->tabela = 'disciplinaspos';
        $this->cursospos_codigo = new CursoPos();
        $this->limite_nome = 80;
    }
