...
<html lang="pt-br">
    <head>
        ...
        <script src="/js/scripts/_disciplinasGraduacao.js"></script>
    </head>
    <body>
        <div id="all">
            <header>
            ...
            <article id="article">
                <div class="enquadramento1000px">
                    ...
                    <article class="boxList">
                        <h1>Disciplinas de Cursos de Graduação</h1>
                        <a href="/<?php print $tipoUrl; ?>/disciplinas/graduacao/novo/cadastro.html">Cadastrar Nova Disciplina</a>
                        <?php
                                ...
                                foreach ($objDisciplinas->listarTudo() as $obj) {
                                    ...
                                    <tr$classPar>
                                        ...
                                        <td class=\"alCenter\">
                                            ...
                                            <a href=\"/$tipoUrl/disciplinas/graduacao/$obj->codigo/cadastro.html\" title=\"Editar\">Editar</a>
                                        </td>
                                    </tr>
                                ";
                                }
