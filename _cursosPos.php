...
<html lang="pt-br">
    <head>
        ...
        <script src="/js/scripts/_cursosPos.js"></script>
    </head>
   <body>
        <div id="all">
            <header>
            ...
            <article id="article">
                <div class="enquadramento1000px">
                    ...
                    <article class="boxList">
                        ...
                        <a href="/<?php print $tipoUrl; ?>/cursos/pos-graduacao/novo/cadastro.html">Cadastrar Novo Curso</a>
                        <?php
                                ...
                                <tbody>
                                    ...
                                    <tr$classPar>
                                        ...
                                        <td class=\"alCenter\">
                                            ...
                                            <a href=\"/$tipoUrl/cursos/pos-graduacao/$obj->codigo/cadastro.html\" title=\"Editar\">Editar</a>
                                        </td>
                                    </tr>
                                ";
                                    }
