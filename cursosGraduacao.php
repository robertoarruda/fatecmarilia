        ...
        <div id="all">
            ...
            <article id="article">
                <div class="enquadramento1000px">
                    ...
                    <section>
                        <h2>Perfil Profissiográfico do Tecnólogo</h2>
                        <p><?php print nl2br($objCurso->perfilProfissiografico); ?></p>
                        <h2>Tipo</h2>
                        <p><?php print ($objCurso->tipo == 1) ? 'Ensino Presencial' : 'Ensino a Distância' ; ?>.</p>
                        <h2>Estrutura Curricular</h2>
                        <p><?php print nl2br($objCurso->estruturaCurricular); ?></p>
                        <h2>Duração</h2>
